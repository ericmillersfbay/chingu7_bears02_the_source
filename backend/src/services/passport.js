...
let token
const frontend = process.env.NODE_ENV !== 'production' ? process.env.FRONTEND_DEV : process.env.FRONTEND_PROD
const backend = process.env.NODE_ENV !== 'production' ? process.env.BACKEND_DEV : process.env.BACKEND_PROD
